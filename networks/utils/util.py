...
def cal_subitizing(label, threshold=6, min_size_per=0.005):
    ...
    dst = morphology.remove_small_objects(label, min_size=min_size_per * label.shape[0] * label.shape[1],
                                          connectivity=2)  # remove small connected areas with a threshold
